...
/*static*/ void RawInsertChar(VIEWDATA *vd, int wchar)
{
  ...
  {
    //§₯§ΰ§κ§έ§Ϊ §Υ§ΰ §ά§ΰ§ί§θ§Ρ §ά§ε§γ§ά§Ρ, §β§Φ§Ρ§έ§έ§ΰ§θ§Ϊ§β§ε§Φ§ή §Φ§λ§Φ §ά§ε§γ§ΰ§άκ
...
//is_index >= 0 §Ϊ§γ§α§ΰ§έ§ξ§Ω§ΰ§Σ§Ρ§δ§ξ §α§ΰ§γ§έ§Φ§Υ§ί§Ϊ§Ϋ
//is_index <0 - §Ω§Ρ§Υ§Ρ§δ§ξ  §α§β§Ϊ§ί§ε§Υ§Ϊ§δ§Φ§έ§ξ§ί§ΰξ
