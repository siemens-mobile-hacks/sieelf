...
{
  {NULL,(int)"转到",    LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //0
  {NULL,(int)"书签",     LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //1
  {NULL,(int)"选项",    LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2}, //2
  {NULL,(int)"退出",        LGP_NULL, 0, NULL, MENU_FLAG3, MENU_FLAG2} //3
};
