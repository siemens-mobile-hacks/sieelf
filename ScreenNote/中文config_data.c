...
__root const CFG_HDR cfghdr1_5={CFG_UINT,"颜色",0,24};
__root const int unsigned cfgcolor=7;

__root const CFG_HDR cfghdr1_6={CFG_UINT,"字型",0,15};
...
__root const CFG_HDR cfghdr2_4={CFG_UINT,"颜色",0,24};
__root const int unsigned cfgdcolor=2;

__root const CFG_HDR cfghdr2_5={CFG_UINT,"字型",0,15};
