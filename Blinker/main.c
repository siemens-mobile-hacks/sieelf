...
//dev  0-ÆÁÄ»  1-¼üÅÌ  2-¶¯¸ÐÉÁ¹â  4-Ö¸Ê¾µÆÉÁ¹â
//param1  1 & 0xFFFF  
void LightOn()
{
	if (cfgDispl)
		SetIllumination(0, 1, cfgBright, 0);  //ÆÁÄ»ÉÁ
	if (cfgKbd)
		SetIllumination(1, 1, cfgBright, 0);  //¼üÅÌÉÁ
#ifndef NEWSGOLD
	if (cfgDyn)
		SetIllumination(2, 1, cfgBright, 0);  //¶¯¸ÐÉÁ¹â
#else
	if (cfgLighter)
		SetIllumination(4, 1, cfgBright, 0);  //¸ßÁÁµÆ
#endif
  if (use_vib)
