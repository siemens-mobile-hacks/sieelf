...
#else //#ifdef ELKA
/******************************************
NEWSGOLDЧЦМеЙиЦГ¶ЁТеЈ¬ІвКФєуЦШРґЈ¬by binghelingxi
*******************************************/
//#define FONT_LARGE 0
//#define FONT_LARGE_BOLD 1
//#define FONT_LARGE_ITALIC 2
...
__swi __arm void EEFullReadBlock(int block, void *buf, int offset, int size, int cepid, int msg); //cepid=0xFFFF (allow 0x0 on NSG) ; msg=0x0 
//arm
