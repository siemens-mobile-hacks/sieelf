...
__root const CFG_HDR cfghdr105 = {CFG_CHECKBOX,"多个号码显示",0,0};
__root const int show_more_number=1;

__root const CFG_HDR cfghdr106 = {CFG_CHECKBOX,"区号秀部分显示",0,0};
__root const int cfg_cs_part=0;

__root const CFG_HDR cfghdr107={CFG_UINT,"屏幕拨号控制按键",0,65535};
...
__root const CFG_HDR cfghdr110={CFG_COLOR,"菜单背景",0,99};
__root const int COLOR_MENU_BK=23;

__root const CFG_HDR cfghdr111={CFG_COLOR,"菜单边框",0,99};
__root const int COLOR_MENU_BRD=1;

__root const CFG_HDR cfghdr112={CFG_COLOR,"号码菜单背景",0,99};
__root const int COLOR_NMENU_BK=23;

__root const CFG_HDR cfghdr113={CFG_COLOR,"号码菜单边框",0,99};
__root const int COLOR_NMENU_BRD=1;

__root const CFG_HDR cfghdr114={CFG_COLOR,"未选择号码",0,99};
__root const int COLOR_NOTSELECTED=0;

__root const CFG_HDR cfghdr115={CFG_COLOR,"选择号码",0,99};
__root const int COLOR_SELECTED=1;

__root const CFG_HDR cfghdr116={CFG_COLOR,"号码颜色",0,99};
__root const int COLOR_NUMBER=0;

__root const CFG_HDR cfghdr117={CFG_COLOR,"选择条背景",0,99};
__root const int COLOR_SELECTED_BG=7;

__root const CFG_HDR cfghdr118={CFG_COLOR,"选择条边框",0,99};
__root const int COLOR_SELECTED_BRD=23;

__root const CFG_HDR cfghdr119={CFG_COLOR,"号码条背景",0,99};
__root const int COLOR_NUMBER_BG=23;

__root const CFG_HDR cfghdr120={CFG_COLOR,"号码条边框",0,99};
__root const int COLOR_NUMBER_BRD=0;

__root const CFG_HDR cfghdr121={CFG_COLOR,"快选标识",0,99};
__root const char COLOR_SEARCH_MARK[4]={0xFF,0x0,0x0,0x64};

__root const CFG_HDR cfghdr122={CFG_COLOR,"快选未标识",0,0};
