...
__root const char bgcolor[4] = {0x50, 0x50, 0x50, 0x64};
...
__root const char statbgcolor[4] = {0x50, 0x50, 0x50, 0x64};
__root const CFG_HDR cfghdr24 = {CFG_COLOR, "scrollbar color", 0, 0};
__root const char sbcolor[4] = {0x00, 0x00, 0xFF, 0x64};
__root const CFG_HDR cfghdr25 = {CFG_COLOR, "scrollbar thumb color", 0, 0};
__root const char sbthumbcolor[4] = {0xFF, 0x00, 0xFF, 0x64};
__root const CFG_HDR cfghdr_m21 = {CFG_LEVEL, "", 0, 0};

__root const CFG_HDR cfghdr_m30 = {CFG_LEVEL, "Control", 1, 0};
__root const CFG_HDR cfghdr30 = {CFG_CHECKBOX, "Show scroll bar", 0, 2};
