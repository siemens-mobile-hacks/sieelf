...
__root const CFG_HDR cfghdr9 = { CFG_CBOX, psz_showsysdrv, 0, 2 };
...
__root const CFG_HDR cfghdr25 = { CFG_STR_UTF8, psz_temppath, 0, 63 };
__root const char CONFIG_TEMP_PATH[64] = DEFAULT_DISK":\\Temp";

__root const CFG_HDR cfghdr26 = { CFG_CBOX, psz_cleartemp, 0, 2 };
__root const int CONFIG_DELETE_TEMP_FILES_ON_EXIT = 0;
__root const CFG_CBOX_ITEM cfgcbox26[] = { psz_no, psz_yes };
