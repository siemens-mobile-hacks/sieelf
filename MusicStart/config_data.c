...
__root const CFG_HDR cfghdr8={CFG_COLOR,"Name Color",0,0};
__root const char gui_name_col[4]={255,255,255,100};

__root const CFG_HDR cfghdr9={CFG_COLOR,"Name Frame Color",0,0};
...
__root const CFG_HDR cfghdr12={CFG_COLOR,"Status Color",0,0};
__root const char gui_sta_col[4]={255,255,255,100};

__root const CFG_HDR cfghdr13={CFG_COLOR,"Status Frame Color",0,0};
__root const char gui_sta_frame_col[4]={255,255,255,0};

__root const CFG_HDR cfghdr14={CFG_UINT,"SoftKey Font",0,65535};
__root const unsigned int sk_font=FONT_MEDIUM;

__root const CFG_HDR cfghdr15={CFG_COLOR,"SoftKey Color",0,0};
