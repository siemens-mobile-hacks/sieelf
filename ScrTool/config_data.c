...
__root const uint APPTEXT_FONT=FONT_SMALL;
...
__root const uint TEXT_FONT=FONT_LARGE;
...
__root const CFG_HDR cfghdrTSI2_3={CFG_CBOX,"Temp Font",0,12};
__root const uint TEMP_FONT=FONT_SMALL;
...
__root const uint VOLT_FONT=FONT_SMALL;
...
__root const uint RAM_FONT=FONT_SMALL;
...
__root const uint WEEK_FONT=FONT_SMALL_ITALIC;
...
__root const uint DATE_FONT=FONT_SMALL;
...
__root const uint TIME_FONT=FONT_LARGE;
...
__root const uint NongLiNian_FONT=FONT_SMALL;
...
__root const CFG_HDR cfghdrTSI9_5={CFG_CBOX,"CHSDay Font",0,12};
__root const uint NongLiDATE_FONT=FONT_SMALL;
...
__root const uint NET_FONT=FONT_SMALL;
...
__root const uint ACCU_FONT=FONT_SMALL;
...
__root const uint GPRS_FONT=FONT_SMALL;
...
__root const uint CPU_FONT=FONT_SMALL;
...
__root const CFG_HDR cfghdrBIR_1={CFG_CHECKBOX, "BDAY Show", 0, 2};
...
__root const uint BIR_FONT=FONT_SMALL;
