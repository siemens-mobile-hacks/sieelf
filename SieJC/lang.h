...
///////////////////////////////////////////////////////////////////////////////////////////
#ifdef LANG_UA
#define LG_SELECT           "Виб?р"
#define LG_BACK             "Назад"
#define LG_OK               "Добре"
#define LG_CLOSE            "Закрити"
#define LG_MENU             "Меню"
#define LG_CANCEL           "В?дм?нити"
#define LG_EXIT             "Вих?д"
#define LG_HELP             "Допомога"
#define LG_UPDATE           "Оновити"
//status_schange.c
#define LG_STATUSSEL        "Виб?р статусу"
#define LG_STONLINE         "В мереж?"
#define LG_STCHAT           "Готовий до розмови"
#define LG_STAWAY           "В?дсутн?й"
#define LG_STXA             "Недоступний"
#define LG_STDND            "Зайнятий"
#define LG_STINVIS          "Невидимий"
#define LG_STOFFLINE        "Оффлайн"
#define LG_STATUS           "Статус"
#define LG_ENTERTEXTSTATUS  "Введ?ть текст статусу:"
#define LG_PRIORITY         "Приоритет:"
//MUC_Enter_UI.c
#define LG_NONAMECONF       "Им'я конференц?? не заповнено!"
#define LG_ENTERMUC         "Вх?д в MUC"
#define LG_NAMEMUC          "Им'я конференц??:"
#define LG_NICK             "Н?к:"
#define LG_GETMESSAGECOUNT  "Отримати пов?домлень:"
//message_list.c
#define LG_NOSENDNULLMESS   "Не можна в?д?слати порожн? пов?домлення!"
#define LG_NEW              "Нове..."
//message_cmds.c
#define LG_SELCOMMAND       "Виб?р команди..."
#define LG_SELTEMPLATE      "Виб?р шаблону..."
#define LG_SELSMILE         "Виб?р смайлу..."
#define LG_SELECT2          "Виб?р..."
#define LG_CONTRESOURCES    "Ресурси..."
#define LG_CONTRESOURCE     "Н?ки"
#define LG_COMMANDS         "Команди"
#define LG_MSGTEMPLATE      "Шаблони пов?домлень"
#define LG_SMILE            "Смайли"
#define LG_CLOSEDLG         "Закрити д?алог"
//mainmenu.c
#define LG_CONTACT          "Контакт"
#define LG_STATUS           "Статус"
#define LG_MUC              "Конференц?я"
#define LG_BOOKMARK         "Закладки"
#define LG_MVIBRA           "Режим в?бри"
...
#define LG_ZLIBNOSASL       "ZLib не працю? без SASL!"
#define LG_ENTERLOGPAS      "Введ?ть лог?н/пароль!"
#define LG_PLATFORMM        "Платформа не в?дпов?да?!"
#define LG_ASTARTED         "Вже викону?ться!"
//jabber_util.c
#define LG_MUCEXITDONE      "Вих?д из MUC виконано!"
#define LG_VERINFO          "Version Info:\nName:%s\nVersion:%s\nOS:%s"
#define LG_TIMEINFO         "Time Info:\nUTC:%s\nTime Zone:%s\n:>%s"
#define LG_LASTACTIVMSG     "IDLE: %d d. %d hr. %d min. %d sec." //почемуто кирилица вызывает Bad UTF encoding..
//item_info.c
#define LG_ITEMIHDR         "Контакт ?нфо"
#define LG_ELROSTER         "Елемент ростеру"
#define LG_OFFLORCONTTR     "Оффлайн або контакт ?з транспорту"
#define LG_MUCPART          "Учасник конференц??"
#define LG_JTRANSP          "Данний контакт ? транспортом Jabber"
#define LG_GROUPROSTER      "Група ростеру"
#define LG_RESOURCE         "Ресурс:"
#define LG_PRIORITY         "Приоритет:"
#define LG_REALJID          "Реальний JID:"
#define LG_STATUS2          "Статус:"
#define LG_PRIVILEGES       "Прив?ле?:"
#define LG_ROLE             "Роль:"
#define LG_POSIBLCLIENT     "Можливост? кл??нта:"
#define LG_MUCSABJECT       "Тема:"
//#define LG_MUCNICK          "Н?к:"
#define LG_ISUBSCRIBE       "Авторизац?я:"
//history.c
#define LG_ERRORWH          "Помилка I/O #%u при запису ?стор??!"
//cont_menu.c
#define LG_MENUCONTACT      "Меню контакту"
#define LG_UNKACTION        "Д?я нев?дома або не п?дтриму?ться!"
#define LG_ABANDON          "Покинути"
#define LG_MUC_ADMIN        "muc#admin"
#define LG_KIK              "К?к"
#define LG_BAN              "Бан"
#define LG_LVOISE           "В?дняти голос"     
#define LG_GVOISE           "Дати голос"
#define LG_PARTICIPANT      "В?дняти членство"
#define LG_MEMBER           "Дати членство"
#define LG_MODERATOR        "Дати модератора"
#define LG_MODERATOR_REMOVE "В?дняти модератора"
#define LG_ADMIN            "Дати адм?на"
#define LG_OWNER            "Дати власника"
#define LG_VERCLIENT        "Верс?я кл??нту"
#define LG_INFOFDISC        "?нфо ?з Disco"
#define LG_ON               "Включити"
#define LG_OFF              "В?дключити"
#define LG_NOSUPACTION      "Нема? п?дтримуваних д?й"
#define LG_OHISTORY         "?стор?я"
#define LG_QUERYTIME        "Час"
#define LG_QUERYVCARD       "vCard"
#define LG_QUERYLAST        "Last Activity"
#define LG_SUBSCR           "Авторизац?я"
#define LG_EDIT             "Зм?нити"
#define LG_MUCCLEAR         "Очистити пов?домлення"
#define LG_SUBSCRIBE        "Запросити"
#define LG_SUBSCRIBED       "Дозволити"
#define LG_UNSUBSCRIBED     "В?дхилити"
#define LG_UNSUBSCRIBE      "Видалити"
#define LG_REASON           "Причина"
//clist_util.c
#define LG_AUTHORREM        "В авторизац?? в?дмовлено!"
#define LG_AUTHORGRANTED    "Авторизац?я надана!"
#define LG_MUCCROK          "Конференц?я створена усп?шно"
//bookmarks.c
#define LG_MENUBOOKMARK     "Меню закладок"
//config_data.c
#define LG_NO               "Н?"
#define LG_YES              "Так"
#define LG_DISABLED         "В?дключити"
#define LG_ENABLED          "Включити"

#define LG_SETUPCONECT      "Налаштування п?дключення"
#define LG_LOGIN            "Лог?н"
#define LG_PASSWORD         "Пароль"
#define LG_SERVER           "Сервер"
#define LG_HOST             "Хост"
...
#define LG_PORT             "Порт"
#define LG_AUTHTYPE         "Авторизац?я"
#define LG_ZLIBUSE          "Використання ZLib"
#define LG_RES              "Ресурс"
#define LG_HISTORY          "?стор?я"
#define LG_MUCHIST          "MUC ?стор?я"
#define LG_MUCDEF           "MUC за умовчанням"
#define LG_MUCDEFMSGCOUNT   "К?л. отриманих пов?домлень"
#define LG_MUCDEFNIK        "Н?к за умовчанням"
#define LG_IDLEICON         "Розташування значка"
#define LG_POPUPDIS         "В?дображати POPUP"
#define LG_COMPOSEV         "Под?? пов?домлень"
#define LG_DELIVREP         "Delivery Report if required"

#define LG_SETUPSND         "Налаштування звуку"
#define LG_SNDVOL           "Гучн?сть"
#define LG_SNDMSGSND        "Звук в?дправки"
#define LG_SNDMSGMUC        "Звук прийому ?з MUC"
#define LG_SNDMSGPM         "Звук прийому ?з PM"
#define LG_SNDONLINE        "Звук статуса онлайн"
#define LG_SNDOFFLINE       "Звук статуса оффлайн"
#define LG_SNDCOMPOSING     "Звук composing-пов?домлень"

#define LG_SETUPPATH        "Налаштування шлях?в"
#define LG_PATHHIST         "?стор?я"
#define LG_PATHPIC          "Картинки"
#define LG_PATHAVATARS      "Аватары"
#define LG_PATHCMD          "Команди"
#define LG_PATHMESG         "Пов?домлення"
#define LG_PATHKNOWF        "В?дом? особливост?"
#define LG_PATHSMILECFG     "Конф?г смайл?в"
#define LG_PATHSMILEDIR     "Каталог смайл?в"
#define LG_DEFAULTDISK      "Диск за умовчанням"

#define LG_TEXTSTATUS       "Текст статус?в"
#define LG_DEFSTATES        "Стани за умовчанням"

#define LG_VIEW             "Вигляд"
#define LG_ROSTER_FONT      "Шрифт ростеру"
#define LG_CHATS_FONT       "Шрифт списку пов?домлень"
#define LG_SMALL_NORMAL_FONT "Малий"
#define LG_SMALL_BOLD_FONT  "Малий жирний"
#define LG_MID_NORMAL_FONT  "Середн?й"
#define LG_MID_BOLD_FONT    "Середн?й жирний"
#define LG_LARGE_NORMAL_FONT "Великий"
#define LG_LARGE_BOLD_FONT  "Великий жирний"
#define LG_UNDERLINING      "П?дкреслення пов?домлень"

#define LG_KBD_LAYOUT       "\"Разкладка\" клав?атури"
#define LG_KBD1             "Разкладка 1"
#define LG_KBD2             "Разкладка 2"
#define LG_SKROLL           "Скрол?нг"
...
#define LG_VCARD_JABBERID   "JID"
#define LG_VCARD_FN         "Повне ?м'я"
#define LG_VCARD_NICKNAME   "Н?к"
#define LG_VCARD_N_FAMILY   "Фам?л?я"
#define LG_VCARD_N_GIVEN    "Им'я"
#define LG_VCARD_N_MIDDLE   "По батьков?"
...
#define LG_VCARD_ORGNAME    "Назва орган?зац??"
#define LG_VCARD_ORGUNIT    "В?дд?л орган?зац??"
...
#define LG_PRIORITY         "优先权:"
//MUC_Enter_UI.c
#define LG_NONAMECONF       "群聊名空白!"
#define LG_ENTERMUC         "加入MUC"
#define LG_NAMEMUC          "MUC名称:"
#define LG_NICK             "昵称:"
#define LG_GETMESSAGECOUNT  "信息数量:"
//message_list.c
#define LG_NOSENDNULLMESS   "不能发送空白信息!"
#define LG_NEW              "新信息..."
//message_cmds.c
#define LG_SELCOMMAND       "选择命令..."
#define LG_SELTEMPLATE      "选择摸板..."
...
#define LG_MVIBRA           "震动"
#define LG_MSOUND           "声音"
#define LG_MOFFLINE         "显示离线"
#define LG_SETTINGS         "设置"
#define LG_ABOUT            "关于..."
#define LG_COLOR            "外观"
#define LG_ADDCONTACT       "增加联系人"
//main.c
#define LG_EXITSIEJC        "退出SieJC?"
#define LG_ZLIBNOSASL       "ZLib doesn't work without SASL!"
#define LG_ENTERLOGPAS      "输入登陆名/密码!"
#define LG_PLATFORMM        "操作平台不符!"
#define LG_ASTARTED         "已经运行"
//jabber_util.c
#define LG_MUCEXITDONE      "退出MUC ok"
#define LG_VERINFO          "版本信息:\n名称:%s\n版本:%s\n操作平台:%s"
#define LG_TIMEINFO         "时间信息:\nUTC:%s\n时区:%s\n:>%s"
#define LG_LASTACTIVMSG     "IDLE: %d d. %d hr. %d min. %d sec."
//item_info.c
...
#define LG_VCARD_ADR_ADR_PCODE  "ADR_PCODE"
#define LG_VCARD_ADR_ADR_CTRY   "ADR_CTRY"
#define LG_VCARD_ADR_REGION   "地区(城市)"
