...
__root const CFG_HDR cfghdr21={CFG_COLOR, "Normal font color", 0, 23};
__root const char cfg_dim_color[4] = {0,0,0,100};

__root const CFG_HDR cfghdr22={CFG_UINT, "Highlight font", 0, 32};
__root const unsigned int cfg_highlight_fontsize = 3;

__root const CFG_HDR cfghdr23={CFG_COLOR, "Hightlight font color", 0, 23};
__root const char cfg_highlight_color[4] = {0,0,0,100};

__root const CFG_HDR cfghdr24={CFG_COLOR, "Hightlight bg color", 0, 23};
__root const char cfg_highlight_bgcolor[4] = {255,255,255,100};

__root const CFG_HDR cfghdr25={CFG_COLOR, "Hightlight frame color", 0, 23};
__root const char cfg_bordercolor[4] = {255,255,255,100};

__root const CFG_HDR cfghdr26={CFG_COLOR, "Scrollbar color", 0, 23};
__root const char cfg_scrollbar_color[4] = {255,255,255,100};

__root const CFG_HDR cfghdr27={CFG_COLOR, "Scrollbar slider color", 0, 23};
__root const char cfg_scrollbar_blkcolor[4] = {255,255,255,100};

__root const CFG_HDR cfghdr28={CFG_COLOR, "Separator line color", 0, 23};
...
__root const CFG_HDR cfghdr36={CFG_COLOR, "Floating win font color", 0, 23};
__root const char cfg_fw_fontcolor[4] = {0,0,0,100};

__root const CFG_HDR cfghdr37={CFG_COLOR, "Floating win bg color", 0, 23};
__root const char cfg_fw_bgcolor[4] = {255,255,255,100};

__root const CFG_HDR cfghdr38={CFG_COLOR, "Floating win frame color", 0, 23};
__root const char cfg_fw_bordercolor[4] = {0,0,0,100};

__root const CFG_HDR cfghdr40={CFG_STR_UTF8, "(.mod.idx) path", 3, 127};
__root const char modidx_dir[128]="4:\\ZBin\\dict\\stardict1.3.mod.idx";

__root const CFG_HDR cfghdr41={CFG_STR_UTF8, "(.dict) path", 3, 127};
__root const char dict_dir[128]="4:\\ZBin\\dict\\stardict1.3.dict";
