...
__root const unsigned int cfg_inputword_y = YDISP;
...
__root const unsigned int cfg_list_y_start = YDISP+20;
...
__root const CFG_HDR cfghdr21={CFG_COLOR, "Normal font color", 0, 0};
...
__root const CFG_HDR cfghdr23={CFG_COLOR, "Hightlight font color", 0, 0};
__root const char cfg_highlight_color[4] = {0,0,0,100};

__root const CFG_HDR cfghdr24={CFG_COLOR, "Hightlight bg color", 0, 0};
__root const char cfg_highlight_bgcolor[4] = {255,0,255,100};

__root const CFG_HDR cfghdr25={CFG_COLOR, "Hightlight frame color", 0, 0};
__root const char cfg_bordercolor[4] = {255,0,255,100};

__root const CFG_HDR cfghdr26={CFG_COLOR, "Scrollbar color", 0, 0};
__root const char cfg_scrollbar_color[4] = {255,0,255,100};

__root const CFG_HDR cfghdr27={CFG_COLOR, "Scrollbar slider color", 0, 0};
__root const char cfg_scrollbar_blkcolor[4] = {255,255,255,100};

__root const CFG_HDR cfghdr28={CFG_COLOR, "Separator line color", 0, 0};
