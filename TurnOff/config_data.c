...
__root const CFG_HDR cfghdr2={CFG_CBOX,"Treatment pressing keys",0,3};
...
__root const CFG_HDR cfghdr2_2={CFG_STR_UTF8,"Sound off",0,127};
__root const char SND_SD[128]=DEFAULT_DISK ":\\ZBin\\sndElfs\\TurnOff\\off.wav";

__root const CFG_HDR cfghdr2_3={CFG_STR_UTF8,"Sound reboot",0,127};
__root const char SND_RB[128]=DEFAULT_DISK ":\\ZBin\\sndElfs\\TurnOff\\reboot.wav";

__root const CFG_HDR cfghdr2_4={CFG_STR_UTF8,"Sound sleep",0,127};
