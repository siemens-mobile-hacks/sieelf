...
void remove_record_sbp(GUI *data)
{
  ...
  while(num)
  {
    ...
    if (!s)  // §¯§Ö §ß§Ñ§ê§Ý§Ú §Ú§Þ§ñ §æ§Ñ§Û§Ý§Ñ §ã§Ö§â§ä§Ú§æ§Ú§Ü§Ú§ä§Ñ §Ó §Þ§Ñ§ß§å§æ§Ñ§Ü§ä§å§â§Ö§â§Ö
    {
    ...
    else  // §¯§Ñ§ê§Ý§Ú - §à§é§Ú§ê§Ñ§Ö§Þ §á§Ñ§Þ§ñ§ä§î §Ú §ß§Ö §Ù§Ñ§ß§à§ã§Ú§Þ §Ó §ã§á§Ú§ã§à§Ü
    {
      mfree(issuer);
      mfree(hash);
    }
  ...
  curpos=lseek(f,0,S_CUR,&err,&err);  // §á§â§à§Ó§Ö§â§ñ§Ö§Þ §ß§Ö §Ó §Ü§à§ß§è§Ö §Ý§Ú §Þ§í §ã§ä§à§Ú§Þ
  oldsize=fsize-curpos;               // §Ö§ã§Ý§Ú §ß§Ö §Ó §Ü§à§ß§è§Ö §ä§à §Ó§í§Õ§Ö§Ý§Ú§Þ §á§Ñ§Þ§ñ§ä§î §Ú §Ù§Ñ§á§Ú§ê§Ö§Þ §ä§å§Õ§Ñ §à§ã§ä§Ñ§ä§à§Ü
  if(oldsize)                   
  {
...
void FindFiles(const char *path)
{
  ...
  int len;
  WSHDR *ws; 
  if (GetFoldersLevel(path)>=1)  // §¥§à§Ò§Ñ§Ó§Ý§ñ§Ö§Þ §á§Ö§â§Ö§ç§à§Õ §ß§Ñ §å§â§à§Ó§Ö§ß§î §Ó§í§ê§Ö
  {
...
void create_menu_folder(void)
{
  ...
  if (!i) return; //§¯§Ö§é§Ö§Ô§à §ã§à§Ù§Õ§Ñ§Ó§Ñ§ä§î
