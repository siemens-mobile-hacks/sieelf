...
__root const CFG_HDR cfghdr2_0={CFG_CHECKBOX,"无振动",0,0};
...
__root const CFG_HDR cfghdr2_11={CFG_UINT,"提示音效2",0,200};
__root const unsigned int melody2=60;

__root const CFG_HDR cfghdr2_12={CFG_UINT,"提示分钟2",0,59};
