...
//ELKA
#ifdef E71Cv41
#define ADDR_wstrlen  0xA0510126+1
...
#ifdef C81Cv50
#define ADDR_strlen		0xA1417C69 //30B4441C810708D001780130
#define ADDR_atou		0xA02C77F9 //002200E001300178
#define ADDR_WS_InitByZero	0xA01F7023 //70B5061C151C0C1C002903D06900
#define ADDR_GetCalleeNumber	0xA097A3AF //70B50E1C041C0128A0B0
#define ADDR_UpdateWndItem	0xA0A3784D //B0B500680D1C91004018C4680021201C
#define ADDR_memcmp		0xA1416E29 //10B4042A0ED3031C0B439B07
#define ADDR_IncommingPDU	0xA8ED6C90 //lib

#define ADDR_wsAppendChar	0xA01F72A1 //10B5021C0DD0101CFFF750FF
#define ADDR_IsCalling		0xA0DDF045 //70B50025????????1E4E0124
#define ADDR_CallIN		0xA02FB4BD //10B586B0????????00240004

#define BASEADDRESS		0xA1580000

#define ADDR_GetPhoneBookNum	0xA098148F //90B50C1C8BB069462A22

#define ADDR_CallOUT2		0xA0A85C97 //F0B5051C0E1C91B006A9
#define	AllocMLMenuItem_adr	0xA09A539B //B5051CFCF763FE041C
#define GetMLMenuGUI_adr	0xA09A4B8D //B0B5041C11200D1C4001A047
