...
/*
int CrtMenu::CreateMenu(const ML_MENU_DESC *menu, const HEADER_DESC *hdr, int start_item, int n_items, void *user_pointer)
{
  void *ma=malloc_adr();
...
int CrtMenu::CreateMenu(const MENU_DESC *menu, const HEADER_DESC *hdr, int start_item, int n_items, void *user_pointer)
{
  void *ma=malloc_adr();
...
int CrtMenu::CreateMenu(const MENU_DESC *menu, const HEADER_DESC *hdr, int start_item, int n_items, void *user_pointer, int flag_30or2)
{
  void *ma=malloc_adr();
  void *gui=GetMenuGUI(ma, mfree_adr());
  SetMenuToGUI(gui, menu);
  ...
  SetCursorToMenuItem(gui, start_item);
  SetHeaderToMenu(gui, hdr, ma);
  if(flag_30or2) return CreateGUI_30or2(gui);
  else return CreateGUI(gui);
}


int CrtMenu::CreateMenu(const ML_MENU_DESC *menu, const HEADER_DESC *hdr, WSHDR *hdr_t, int start_item, int n_items, void *user_pointer)
{
  void *ma=malloc_adr();
  void *mf=mfree_adr();
...
int CrtMenu::CreateMenu(const MENU_DESC *menu, const HEADER_DESC *hdr, WSHDR *hdr_t, int start_item, int n_items, void *user_pointer)
{
  void *ma=malloc_adr();
  void *mf=mfree_adr();
